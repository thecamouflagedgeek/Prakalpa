...
if (!complaint) {
return ( <div style={styles.loading}> <div style={styles.loadingCard}> <div style={styles.loadingSpinner} /> <div>{error || t.loadingCase}</div> </div> </div>
);
}

return ( <div style={styles.page}> <header style={styles.topbar}> <div style={styles.topbarLeft}>
<button
...
return ( <div style={styles.textSection}> <div style={styles.textSectionTitle}> <span style={styles.sectionMarker} />
{title} </div>
...
return ( <svg width={size} height={size} viewBox="0 0 24 24" fill="none"> <circle
     cx="12"
     cy="12"
     r="10"
     stroke={color}
