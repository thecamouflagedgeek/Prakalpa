...
*Built for Karnataka State Police · Bilingual (English/Kannada) · Decision-support, not decision-making*
...
- **Sarvam** is called *only* when `language == "kn"` — English speech stays free and fast on the browser's native stack.
